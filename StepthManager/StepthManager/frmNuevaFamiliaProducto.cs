...
{
    public partial class frmNuevaFamiliaProducto : Form
    {
        #region Propiedades / Variables
        private int TipoForm = 0;
        private FamiliaProducto _DatosFamilia;
        public FamiliaProducto DatosFamilia
        {
            get { return _DatosFamilia; }
            set { _DatosFamilia = value; }
        }        
        #endregion

        #region Constructor

        public frmNuevaFamiliaProducto()
        {
            try
            {
                InitializeComponent();
