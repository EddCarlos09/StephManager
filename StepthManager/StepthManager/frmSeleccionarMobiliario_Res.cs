...
{
    public partial class frmSeleccionarMobiliario_Res : Form
    {
        ...
        public frmSeleccionarMobiliario_Res()
        {
            try
            {
                InitializeComponent();
        ...
        private void BuscarRegistros(string Busqueda)
        {
            try
            {
                Mobiliario DatosAux = new Mobiliario { Conexion = Comun.Conexion, Descripcion = Busqueda};
                Mobiliario_Negocio MN = new Mobiliario_Negocio();
                MN.ObtenerBusquedaMobiliario_Res(DatosAux);
        ...
        private void btnAgregar_Click(object sender, EventArgs e)
        {
            ...
            {
                LogError.AddExcFileTxt(ex, "frmSeleccionarMobiliario_Res ~ btnAgregar_Click");
        ...
        private void btnBuscar_Click(object sender, EventArgs e)
        {
            ...
            {
                LogError.AddExcFileTxt(ex, "frmSeleccionarMobiliario_Res ~ btnBuscar_Click");
                MessageBox.Show(Comun.MensajeError, Comun.Sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void btnCerrarForm_Click(object sender, EventArgs e)
        {
            ...
            {
                LogError.AddExcFileTxt(ex, "frmSeleccionarMobiliario_Res ~ btnCerrarForm_Click");
                MessageBox.Show(Comun.MensajeError, Comun.Sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void dgvMobiliario_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                LogError.AddExcFileTxt(ex, "frmSeleccionarMobiliario_Res ~ dgvMobiliario_CellDoubleClick");
                MessageBox.Show(Comun.MensajeError, Comun.Sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void dgvMobiliario_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                LogError.AddExcFileTxt(ex, "frmSeleccionarMobiliario_Res ~ dgvMobiliario_KeyPress");
                MessageBox.Show(Comun.MensajeError, Comun.Sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }

        private void frmSeleccionarMobiliario_Res_Load(object sender, EventArgs e)
        {
            try
            {
                this.IniciarForm();
            ...
            {
                LogError.AddExcFileTxt(ex, "frmSeleccionarMobiliario_Res ~ frmSeleccionarMobiliario_Res_Load");
            }
        }
        ...
        private void txtBusqueda_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            {
                LogError.AddExcFileTxt(ex, "frmSeleccionarMobiliario_Res ~ txtBusqueda_KeyPress");
                MessageBox.Show(Comun.MensajeError, Comun.Sistema, MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        private void frmSeleccionarMobiliario_Res_KeyUp(object sender, KeyEventArgs e)
        {
            try
            {
            ...
            {
                LogError.AddExcFileTxt(ex, "frmSeleccionarMobiliario_Res ~ frmSeleccionarMobiliario_Res_KeyUp");
            }
        }
