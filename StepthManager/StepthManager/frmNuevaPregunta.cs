...
{
    public partial class frmNuevaPregunta : Form
    {
        #region Propiedades / Variables 

        private bool NuevoRegistro;
        private Pregunta _DatosPregunta;
        public Pregunta DatosPregunta
        {
            get { return _DatosPregunta; }
            set { _DatosPregunta = value; }
        }
        ...
        public frmNuevaPregunta()
        {
            try
            {
                InitializeComponent();
                NuevoRegistro = true;
                this._DatosPregunta = new Pregunta();
            }
            catch(Exception ex)
            {
                LogError.AddExcFileTxt(ex, "frmNuevaPregunta ~ frmNuevaPregunta()");
            }
        }

        public frmNuevaPregunta(Pregunta DatosAux)
        {
            try
            {
                InitializeComponent();
                NuevoRegistro = false;
                this._DatosPregunta = DatosAux;
            }
            catch (Exception ex)
            {
                LogError.AddExcFileTxt(ex, "frmNuevaPregunta ~ frmNuevaPregunta()");
        ...
        private void IniciarForm()
        {
            try
            {
                ...
                if (NuevoRegistro)
                    ...
                    this.CargarDatosAModificar(this._DatosPregunta);
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    this._DatosPregunta = this.ObtenerDatos();
